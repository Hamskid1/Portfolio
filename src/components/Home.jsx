    ...
    <div>
      ...
      <header className="qq">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <rect width="41.472" height="28.704" fill="whitesmoke" />
          <path
      ...
      <div className="projects abt-me">
        ...
        <div className="abt-div">
          <div className="abt-txt">
            <p>
              Hi, I'm Abdulhameed, <br />
              <br /> I'm a front-end developer and Ui/Ux based in Lagos,
              Nigeria. I've dedicated over a year to crafting responsive
              websites from scratch, focusing on delivering modern and
              user-friendly web experiences. I'm passionate about turning
              creativity and expertise into impactful online solutions, helping
              clients establish their digital presence effectively. <br />
              <br /> In addition to web development, I serve as a Ui/Ux,I'm
              committed to continuous learning and staying updated with the
              latest technologies and frameworks to deliver innovative solutions
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <rect x="-76.5" y="0.5" width="154" height="154" stroke="#ABB2BF" />
        </svg>
      </div>
      <svg
        className="dotbox"
